...
#ifndef markov_REFERENCE_INCLUDED
#define markov_REFERENCE_INCLUDED



//template<typename T>
void __attribute__((noinline)) markov_reference(double *init_change, double **transition_matrix, uint64_t days, uint64_t scale, double *result) {
